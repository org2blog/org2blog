...
[[https://www.gnu.org/software/emacs/][https://img.shields.io/badge/Emacs-%3E%3D%2026.2-brightgreen.svg]] [[https://orgmode.org/][https://img.shields.io/badge/Org%20mode-%3E%3D%209.2.2-brightgreen.svg]] [[https://wordpress.org/about/][https://img.shields.io/badge/WordPress-XML--RPC-brightgreen.svg]]
...
Org2Blog requires Emacs 26.2 and Org mode 9.2.2.
...
- It is fun to build the package yourself to see how it works. Relative to
  this project it is the best way to figure out what you really want in it and
  /then/ set up your MELPA [[https://github.com/melpa/melpa#recipe-format][rec and install this one instead.
...
After plarying around a little bit you should have a better sense of what is
...
When you have =#+name= and =#+caption= on a source block then the values are
...
Now when you post entries they will get logged in your log file under the
...
will try creating and loading the file specified by ~org-directory~. It it can't
do either then you will get a warning message saying why it failed. The
solution is usually to correct the file name or set the ~org-directory~ to
something valid. 
