...
*** Posting source code blocks
    ...
    sourcecode shortcode blocks can be given various [[http://en.support.wordpress.com/code/posting-source-code/#configuration-parameters][configuration
...
* FAQ
  ...
  - I donot use tags. I wish to use them as categories. How?
