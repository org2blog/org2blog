...
Configure your source blocks for SyntaxHighlighter like this. SyntaxHighlighter Evolved automatically uses the default global settings you configured in it's WordPress plugin page.
