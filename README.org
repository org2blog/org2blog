...
- ~org2blog-def-checkout-statement~ creates Git commands to get the code from GitHub
...
- ~org2blog-def-load-statement~ creates Elisp code to load the libraries.
...
~org2blog-user-interface~. You can do literally everything with Org2Blog using it's
...
O2BPASSWORD="password"
        #+END_SRC
      - Load and evaluate [[./tests/org2blog-test-system.el][System Test Program]].
    ...
    - If you need a test WordPress system to use you can set up a free
      WordPress blog [[https://https:/wordpress.com][here]].
