...
Org2Blog requires Emacs 1.1.0 and Org mode 9.2.2.
...
whether its destination is post or a page. Here is the workflow:
...
as more of a personal dashboard. It works both for buffer entries and subtree
