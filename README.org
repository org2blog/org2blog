...
The cutting-edge version contains new changes immediately as they are made. It contains new features and bug fixes faster than the stable version. Although it's very unlikely it may contain breaking changes.
