...
- It provides the package as-intended: it only includes what you need. For
  example the list of Org2Bloggers and the logo image. 
...
- If you already installed the package using another package manager, from
  MELPA and Use Package for example, delete the Org2Blog that got installed
  (probably under ~/.emacs.d/elpa and install this one instead.
