...
[[https://www.gnu.org/philosophy/free-sw.html][https://img.shields.io/badge/Libre%20Software-GPLv3-orange.svg]] [[https://www.gnu.org/software/emacs/][https://img.shields.io/badge/Emacs-%3E%3D%2026.1-brightgreen.svg]] [[https://orgmode.org/][https://img.shields.io/badge/Org%20mode-%3E%3D%209.2-brightgreen.svg]] [[https://wordpress.org/about/][https://img.shields.io/badge/WordPress-XML--RPC-brightgreen.svg]]

[[https://github.com/org2blog/org2blog/releases][https://img.shields.io/github/commits-since/org2blog/org2blog/v1.1.0.svg]] [[https://github.com/org2blog/org2blog/commits][https://img.shields.io/github/last-commit/org2blog/org2blog.svg]] [[https://github.com/org2blog/org2blog/issues][https://img.shields.io/github/issues-closed-raw/org2blog/org2blog.svg]] [[https://github.com/org2blog/org2blog/issues][https://img.shields.io/github/issues-raw/org2blog/org2blog.svg]]
...
For example you can use [[https://melpa.org/#/org2blog][MELPA]] or download the package and install it
manually. 
...
Here are the Git URLs for all of the dependencies (as of 2019-03-09). 
...
With your configuration ready, start creating the entry. 
...
When you are ready to Save/View/Publish then choose from the source (buffer or
subtree) and destination (post or page) and choose the menu item. When you are
ready to delete it, it is just as easy.

The steps are the same: position your cursor in the entry, decide whether it
is a page or a post, and =UI [Trash]= it. Org2Blog uses the =POST_ID= it finds
there. If you want to delete an entry on the server and you don't have have
the entry for it then use =UI [Trash ID]= to manually specify the =POST_ID= to
delete.

That is (and maybe was) your second and much richer post. When you are ready
for more then please read on. 
