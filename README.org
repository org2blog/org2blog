...
With SyntaxHighlighter Evolved disabled:

  [[file:/images/SourceBlockNormal.png]]

Note that in Org mode every source block has a name. If you don't specify one
then it's automatically generated name will be used. For example:

  [[file:/images/SourceBlockNormalNoname.png]]
...
override it with the line ~#+attr_wp: :syntaxhl light="true"~ placed before the
...
With SyntaxHighlighter Evolved enabled:
  ...
  [[file:/images/SourceBlockSyntaxHighlighterExposed.png]]

  [[file:/images/SourceBlockSyntaxHighlighterExposedNoName.png]]
