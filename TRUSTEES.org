...
- [[#the-one-critical-responsibility-of-a-trustee][The ONE CRITICAL Responsibility Of A Trustee]]
...
* The ONE CRITICAL Responsibility Of A Trustee

- Ensure that there are two trustees. That is the only critical requirement. Everything else is secondary.
- Their singular minimum purpose for existence is that the project is managed and never orphaned. Yes, it can be cloned, but it is immensely easier to maintain management of the same repository.
...
- When the project faces the loss of its Maintainers, you are willing to invest your time and effort in adhering to the Trustee's Commitment
- /Specifically And Most Importantly/
  - Always ensure there are two Trustees
  When all the Maintainers are gone, seek out new ones who are as aligned as possible with the vision and standards of the project you know and love today.
