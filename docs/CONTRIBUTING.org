...
- *The Future* :: [[https://github.com/org2blog/org2blog/FUTURE.org][The future file]] may already have new features listed, and if it doesn't then maybe it should. Either way it might be a great place to start.
