...
string generated by org-export-as-html"
  (substring html-text (string-match "<body>" html-text) (string-match "</body>" html-text)))
        ...
        (save-excursion
          (if (not narrow-p)
              (setq html-text
                    ...
                    (condition-case nil
                        (org2blog/wp-retrieve-html-body (org-export-as-html nil nil nil 'string nil nil))
                      (wrong-number-of-arguments
                       (org2blog/wp-retrieve-html-body (org-export-as-html nil nil 'string nil nil)))))
            (setq html-text
                  (org2blog/wp-retrieve-html-body (org-export-region-as-html
