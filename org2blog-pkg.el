(define-package "org2blog" "1.1.16" "Blog from Org mode to WordPress"
  '((htmlize "1.56" "https://github.com/hniksic/emacs-htmlize.git")
    ...
    (writegood-mode "2.2.0" "https://github.com/bnbeckwith/writegood-mode")
    (metaweblog "1.1.16" "https://github.com/org2blog/org2blog.git"))
  :authors
